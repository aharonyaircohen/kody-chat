 ...
 * @ai-summary Per-user unread tracking for system report families. A family is
 *   "unread" when its latest run timestamp advances past the locally-stored
 *   `lastSeen[slug]` ISO timestamp.
