 ...
 * @domain kody
 * @pattern vibe-toggle
 * @ai-summary Single labelled toggle for the Vibe view. Visually reflects the
 *   current state — glowing fuchsia when on `/vibe`, idle otherwise. Clicking
 *   always navigates to the *other* state, making it a true on/off switch.
 *   The "Vibe" text label keeps it from reading as just another icon button
 *   beside the search/filter controls.
 */
"use client";
