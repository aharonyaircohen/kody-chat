 ...
 *
 *   Stored in the backend at `macros.json` via /api/kody/macros, so
...
import { formatMacroForChat, type Macro } from "@dashboard/lib/macros";
import { useAuth, buildAuthHeaders } from "@dashboard/lib/auth-context";
import type { PreviewAction, PreviewActResult } from "@dashboard/lib/picker/protocol";
