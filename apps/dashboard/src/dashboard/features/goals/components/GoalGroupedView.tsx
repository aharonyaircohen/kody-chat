...
import type { Goal } from "@dashboard/lib/api";
import { GOAL_LABEL_PREFIX } from "@dashboard/lib/goals";
import { goalPalette } from "@dashboard/lib/goal-palette";
import { useReorderGoals } from "@dashboard/lib/hooks/useGoals";
import { useGitHubIdentity } from "@dashboard/lib/hooks/useGitHubIdentity";
import {
  useGoalState,
  useMergeGoal,
  useManageGoal,
} from "@dashboard/lib/hooks/useGoalState";
import { useClosedGoalTasks } from "@dashboard/lib/hooks/useClosedGoalTasks";
import { usePersistedSet } from "@dashboard/lib/hooks/usePersistedState";
import { TaskList } from "@dashboard/features/tasks/components/TaskList";
import { GoalProgressRing } from "@dashboard/features/goals/components/GoalProgressRing";
