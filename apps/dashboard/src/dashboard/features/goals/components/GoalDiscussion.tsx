...
} from "@dashboard/lib/hooks/useGoals";
...
import type { DiscussionDisabledReason, GoalDiscussionComment } from "@dashboard/lib/api";
import { useMentionRoster, type MentionEntry } from "@dashboard/lib/hooks/useMentionRoster";
...
function DiscussionCommentEditor({ goalId }: { goalId: string }) {
  ...
  // @mention autofill — shared roster: collaborators + agent + self.
  // Agent (e.g. @cto) are offered here just like in channels; an agent
