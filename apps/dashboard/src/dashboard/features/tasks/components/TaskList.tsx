...
import { AnimatedStatusBar } from "@dashboard/lib/components/v2/AnimatedStatusBar";
...
} from "@dashboard/lib/components/tooltip-content";
...
import { UIVerifyBadge } from "@dashboard/lib/components/UIVerifyBadge";
            ...
            <div className="hidden sm:flex items-center -space-x-1.5 shrink-0">
              ...
              {task.pipeline?.triggeredByLogin &&
                !task.assignees?.some(
                  ...
                  >
                    <span className="inline-block">
                      <Avatar className="h-5 w-5 ring-2 ring-background opacity-60">
                        <AvatarImage
              ...
              {task.pipeline?.issueCreator &&
                task.pipeline.issueCreator !==
                  ...
                  >
                    <span className="inline-block">
                      <Avatar className="h-5 w-5 ring-2 ring-background opacity-80">
                        <AvatarImage
