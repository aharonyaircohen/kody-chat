...
vi.mock("@kody-chat/chat/core/kody-chat-live-session", () => ({
...
} from "@kody-chat/chat/plugins/terminal/useChatTerminalRegistry";
import { FLY_MACHINES_REFRESH_EVENT } from "@kody-chat/chat/plugins/terminal/registry-state";
