...
const ROUTE_SOURCE = readFileSync(
  resolve(__dirname, "../../../../packages/brain/src/routes/image.ts"),
  "utf8",
);
const IMAGE_SAVE_COMMAND_SOURCE = readFileSync(
  resolve(__dirname, "../../../../packages/brain/src/image-save-command.ts"),
  "utf8",
);
const IMAGE_MANAGEMENT_SOURCE = readFileSync(
  resolve(__dirname, "../../../../packages/brain/src/image-management.ts"),
  "utf8",
);
...
const APPLY_ROUTE_SOURCE = readFileSync(
  resolve(__dirname, "../../../../packages/brain/src/routes/image-apply.ts"),
  "utf8",
);
const APPLY_SERVICE_SOURCE = readFileSync(
  resolve(__dirname, "../../../../packages/brain/src/image-apply.ts"),
  "utf8",
);
const WORKER_ROUTE_SOURCE = readFileSync(
  resolve(__dirname, "../../app/api/kody/brain/image/worker/route.ts"),
  "utf8",
);
