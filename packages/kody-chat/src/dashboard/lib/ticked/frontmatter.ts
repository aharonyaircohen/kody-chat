 ...
 * @ai-summary Tiny YAML-frontmatter parser/serializer for markdown-backed
 *   agent identity records and shared schedule helpers.
 *
 *   No `gray-matter` dep on purpose — the format is intentionally
 *   restricted (flat, scalar values only) and a small parser keeps the
 *   bundle small.
 */
