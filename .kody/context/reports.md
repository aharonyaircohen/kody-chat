...
- `company-graph`: Kody structure, agentResponsibilities, agent, agentActions, skills, and context links.
...
Do not hand-edit reports. Refresh them through their matching agentResponsibility.
