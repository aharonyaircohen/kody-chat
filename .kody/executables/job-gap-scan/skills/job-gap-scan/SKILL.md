...
Use this skill when the `job-gap-scan` executable runs from the matching duty.
...
issue with the reason, score, suggested duty frontmatter, and any executable or
skill that would be needed. Do not write the duty file yourself.
...
- Never create or edit duty files.
